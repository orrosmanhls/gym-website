...
<?php while (have_posts()) : the_post(); ?>
    ...
    <section class="welcome text-center section-title">
    ...
    <section class="blog container section">
        ...
        <p class="text-center">Read our experts blog to achieve your goals.</p>
